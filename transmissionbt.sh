...
echo "========================================================================="
yum -y install unzip wget xz gcc gcc-c++ m4 make automake libtool gettext openssl-devel pkgconfig perl-libwww-perl perl-XML-Parser curl curl-devel libidn-devel zlib-devel which
...
cd /root
wget -c http://ptimg.4khezi.com/intltool-0.40.6.tar.gz -O intltool-0.40.6.tar.gz
...
make -s install
cd ..
wget -c http://ptimg.4khezi.com/libevent-2.0.21-stable.tar.gz -O libevent-2.0.21-stable.tar.gz
...
cd /root
wget -c http://ptimg.4khezi.com/transmission-2.84.zip -O transmission-2.84.zip
...
wget http://ptimg.4khezi.com/transmission.sh -O /etc/init.d/transmissiond
chmod 755 /etc/init.d/transmissiond
chkconfig --add transmissiond
chkconfig --level 2345 transmissiond on
mkdir -p /home/transmission/Downloads/
chmod g+w /home/transmission/Downloads/
wget -c http://ptimg.4khezi.com/settings.json
...
wget -c http://ptimg.4khezi.com/index.html
